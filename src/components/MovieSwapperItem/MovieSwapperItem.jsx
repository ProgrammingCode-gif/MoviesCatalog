            ...
            <div className={styles.currentMovie}>
                {activeMovie && activeMovie.id === movie.id && (
                    <Container className={styles.currentMovieAbout}>
                        ...
                        <Link className={styles.link} to={movie.title ? `/movies/${movie.id}` : `/series/${movie.id}`}>
                            <motion.button
                ...
                <img className={styles.background} src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} alt="" />
            </div>
            <div></div>
            {activeMovie && activeMovie.id === movie.id && (
                <motion.div
